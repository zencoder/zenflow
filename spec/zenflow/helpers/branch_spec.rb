  ...
  describe "self.track" do
    ...
    context "when a remote is configured" do
      ...
      it "tracks the branch in that remote" do
        ...
        Zenflow::Shell.should_receive(:run).with("git branch --set-upstream feature/test-tracking some-remote/feature/test-tracking")
    ...
    context "when a remote is not configured" do
      ...
      it "tracks the branch in origin" do
        ...
        Zenflow::Shell.should_receive(:run).with("git branch --set-upstream feature/test-tracking origin/feature/test-tracking")
        Zenflow::Branch.track('feature/test-tracking')
      end
    end
  end
